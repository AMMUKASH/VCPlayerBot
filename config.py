...
class Config:
    ...
    # ─── ʏᴏᴜʀ ᴄᴜꜱᴛᴏᴍ ᴄʀᴇᴅᴇɴᴛɪᴀʟꜱ ꜱᴇᴛᴛɪɴɢꜱ ───
    ...
    CHAT = int(os.environ.get("CHAT", "-1003947649552")) # Defaulted to your log group if not specified
    ...
    # ─── ꜱᴛʏʟɪꜱʜ ꜱᴍᴀʟʟ ᴄ Caps ʜᴇʟᴘ ꜱᴛʀɪɴɢꜱ ───
...
📢 **ᴜᴘᴅᴀᴛᴇꜱ:** [ɢᴇɴᴜ ʙᴏᴛ ꜱᴜᴘᴘᴏʀᴛ](https://t.me/Genu_Bot_Support)
"""
...
**ᴇᴅɪᴛ ᴛɪᴛʟᴇ** - __ᴇᴅɪᴛ ᴠɪᴅᴇᴏᴄʜᴀᴛ ᴛɪᴛʟᴇ ᴛᴏ ᴄᴜcurrent ꜱᴏɴɢ ɴᴀᴍᴇ.__
"""

    SCHEDULER_HELP="""
__ᴠᴄᴘʟᴀʏᴇʀ ᴀʟʟᴏᴡꜱ ʏᴏᴜ ᴛᴏ ꜱᴄʜᴇᴅᴜʟᴇ ᴀ ꜱᴛʀᴇᴀᴍ ꜰᴏʀ ꜰᴜᴛᴜʀᴇ.__
...
"""
    ...
    RECORDER_HELP="""
__ᴇᴀꜱɪʟʏ ʀᴇᴄᴏʀᴅ ᴀʟʟ ʏᴏᴜʀ ᴠɪᴅᴇᴏ ᴄʜᴀᴛꜱ ᴜꜱɪɴɢ ᴛʜᴇꜱᴇ ᴄᴏᴍᴍᴀɴᴅꜱ.__

ᴄᴏᴍᴍᴀɴᴅ: **/record**

1. **ʀᴇᴄᴏʀᴅ ᴠɪᴅᴇᴏ:** __ᴇɴᴀʙʟᴇ/ᴅɪꜱᴀʙʟᴇ ᴠɪᴅᴇᴏ ʀᴇᴄᴏʀᴅɪɴɢ.__
2. **ᴠɪᴅᴇᴏ ᴅɪᴍᴇɴꜱɪᴏɴ:** __ᴄʜᴏᴏꜱᴇ ᴘᴏʀᴛʀᴀɪᴛ ᴏʀ ʟᴀɴᴅꜱᴄᴀᴘᴇ.__
...
• **/clearplaylist** - __ᴄʟᴇᴀʀ ᴀʟʟ Qᴜᴇᴜᴇꜱ__
